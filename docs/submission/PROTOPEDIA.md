...
自治体の議事録・プレスリリースを AI が読み、役所言葉を若者の言葉に翻訳して TikTok 風フィードで届けるマルチエージェントプロダクト。「街の見張り番」Watcher エージェントが自分で調査計画を立て、統計・議題・人口推移を並列調査して「あなたに合う街」を自己検証つきで結論します。全国830の自治体・議会、4,500件超の議題を処理。
